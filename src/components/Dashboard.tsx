...
import { BookOpen, Brain, MessageCircle, Calendar, BarChart3, FileText, Menu, X, GraduationCap } from "lucide-react";
...
export default function Dashboard() {
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:static z-50 inset-y-0 left-0 w-64 bg-sidebar border-r border-sidebar-border transform transition-transform md:translate-x-0 ${
